...
def accuracy_from_logits(logits: torch.Tensor, targets: torch.Tensor) -> float:
    """
    Calcule l'accuracy (en %) à partir des logits et des labels.
    """
...
def train_one_epoch(model, loader, optimizer, criterion, device):
    ...
    for batch_idx, (X, y) in enumerate(loader):
        ...
        # 🔍 debug : afficher la progression de l'epoch
...
def main():
    ...
    learning_rate = 1e-3
    n_mels = 128
    n_classes = 8          # à adapter si tu as un autre nombre de genres
    ...
    best_valid_acc = 0.0
    best_model_path = CHECKPOINT_DIR / "baseline_cnn_best.pt"
    ...
    # ========================
    history_path = CHECKPOINT_DIR / "baseline_cnn_history.json"
